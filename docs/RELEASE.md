...
- [ ] `gh release list -R AlgoJudge/AlgoJudge-Ops` names the tag just pushed.
...
`algojudge.pl` prints **`Ops v0.1.0`** in four places — a card badge and
...
- `AlgoJudge-Website/tests/content.test.mjs:125` **pins the literal** by regex,
  `Ops v0\.1\.0`, and hard-codes the five repository keys. Correcting
